...
import TablePendentes from '~components/monitores/TablePendentes'
import TableHistorico from '~components/monitores/TableHistorico'
...
export default class Reservas extends Component {
  ...
  aplicada(id) {
    Auth.fetch('/api/reservas/aplica', {
      method: 'POST',
      body: JSON.stringify({
        id: id
      })
